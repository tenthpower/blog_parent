...
//    }
    ...
    public static MimeMessage createMimeMessage(Session session, EmailVo emailVo) throws Exception {
        ...
        if (emailVo.getReceiverPeopleVos() != null && emailVo.getReceiverPeopleVos().size() > 0) {
            List<ReceiverPeoperVo> peopers = emailVo.getReceiverPeopleVos();
    ...
    public static String sendEmailByJodd(EmailVo emailVo) throws Exception {
        ...
        try {
            ...
            List<ReceiverPeoperVo> receives = emailVo.getReceiverPeopleVos();
            //发送给多个邮件接收者
