    ...
    if (0 == type) {
        ...
        onlinePublicUsers.forEach(function iForEach(item, index) {
            var userInfoVar =
                ...
                "   <div id = "+item.sid+" class='liLeft'><img src=\"img/photo.jpg\"/></div>\n" +
                "   <div class='liRight'>\n" +
                "        <span class='intername'>"+item.name+"</span>\n" +
        ...
        if (changeUserInfo == null) {
            ...
            var userInfoVar =
                "<li style='background: #ebebec;'>\n" +
                "   <div id = "+data.sid+" class='liLeft'><img src=\"img/photo.jpg\"/></div>\n" +
                "   <div class='liRight'>\n" +
                "        <span class='intername'>"+data.name+"</span>\n" +
                "        <span class='infor'>[暂无]</span>\n" +
                "   </div>\n" +
                "</li>";
            $("#chatListUl").append(userInfoVar);
...
function showResponse(data){
    ...
    if (data.sendSid == userInfo.sid) {
        message =
            "<li>\n" +
            "     <div class=\"nesHead\"><img src='img/photo.jpg'/></div>\n" +
            "     <div class=\"news\">\n" +
            "          <img class='jiao' src='img/talk.jpg'>"+ data.sendMessage +"\n" +
            "     </div>\n" +
            "</li>";
    } else {
        message =
            "<li>\n" +
            "    <div class=\"answerHead\"><img src='img/photo.jpg'/></div>\n" +
            "    <div class=\"answers\">\n" +
            "         <img class='jiao' src='img/message.jpg'>"+ data.sendMessage +"\n" +
            "    </div>\n" +
            "</li>";
    }
