...
import com.blog.service.ProblemService;
...
public class ProblemController {
     ...
     * @return
     */
    @DeleteMapping(value="/problem/{id}")
     ...
     * @return
     */
    @GetMapping(value="/problem/newlist/{labelid}/{page}/{size}")
     ...
     * @return
     */
    @GetMapping(value="/problem/hotlist/{labelid}/{page}/{size}")
     ...
     * @return
     */
    @GetMapping(value="/problem/waitlist/{labelid}/{page}/{size}")
